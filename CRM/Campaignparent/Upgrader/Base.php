 ...
 */
class CRM_Campaignparent_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Campaignparent_Upgrader(
        'nl.pum.campaignparent',
        realpath(__DIR__ .'/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_Campaignparent_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
